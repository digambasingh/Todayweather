...
const getInfo = async(event) => {
    ...
    if(cityVal === ""){
       ...
       dataHide.classList.add('data_hide'); 
        ...
        try{
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=b2a89ab5d0e20dbe630abe610b5022d1`;
            ...
            humidity.innerHTML = `<strong>Humidity:</strong> ${arrData[0].main.humidity}%`;
            visibility.innerHTML = `<strong>Visibility:</strong> ${arrData[0].visibility / 1000} km`;
